...
Для получение списка полей смарт-процесса использутся метод `getFieldsCollection`, он возвращает экземпляр `Bitrix\Crm\Field\Collection` с описанием всех полей элемента смарт-процесса
